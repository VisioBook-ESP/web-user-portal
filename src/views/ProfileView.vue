        ...
        <div v-if="activeSection === 'password'" class="section-content">
          <div class="form-group">
            ...
            <div class="input-with-icon">
              ...
              />
              <button class="icon-toggle" @click="showCurrentPassword = !showCurrentPassword">
          ...
          <div class="form-group">
            ...
            <div class="input-with-icon">
              ...
              />
              <button class="icon-toggle" @click="showNewPassword = !showNewPassword">
          ...
          <div class="form-group">
            ...
            <div class="input-with-icon">
              ...
              />
              <button class="icon-toggle" @click="showConfirmPassword = !showConfirmPassword">
        ...
        <div v-if="activeSection === 'premium'" class="section-content">
          <div v-if="false" class="premium-status active">
            ...
            <div class="premium-features">
              <div class="feature-item"><Check :size="16" color="#4CAF50" /> Unlimited VisioBooks</div>
              <div class="feature-item"><Check :size="16" color="#4CAF50" /> Priority Processing</div>
              <div class="feature-item"><Check :size="16" color="#4CAF50" /> 4K Video Export</div>
              <div class="feature-item"><Check :size="16" color="#4CAF50" /> No Watermarks</div>
              <div class="feature-item"><Check :size="16" color="#4CAF50" /> Premium Support</div>
            </div>
          </div>
        ...
        <div v-if="activeSection === 'notifications'" class="section-content">
          <div class="toggle-group">
            ...
            <div class="toggle-item">
              ...
              <label class="toggle-switch">
                <input type="checkbox" v-model="notificationSettings.projectUpdates" />
                <span class="slider"></span>
              </label>
            </div>
            ...
            <div class="toggle-item">
              ...
              <label class="toggle-switch">
                <input type="checkbox" v-model="notificationSettings.marketingEmails" />
                <span class="slider"></span>
              </label>
            </div>
            ...
            <div class="toggle-item">
              ...
              <label class="toggle-switch">
                <input type="checkbox" v-model="notificationSettings.securityAlerts" />
                <span class="slider"></span>
              </label>
            </div>
          </div>
